...
public class EShopDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
{
    ...
    //ilgili entityler için propertyler oluşturuldu.
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            entity.HasKey(x => new { x.ProductId, x.CategoryId });//Çoktan çok ilişki. Bir ürün birden fazla kategoriye ait olabilir. Bir kategoriye birden fazla ürün ait olabilir. HasKey metodu ile birincil anahtar belirtilir. ProductId ve CategoryId birincil anahtar olarak belirlenir. ProductCategory tablosunda bu iki alan birincil anahtar olarak belirlenir.

            //Product=>ProductCategory 1e çok ilişki
            entity
        ...
        builder.Entity<Category>(entity =>
        {
            ...
            entity.HasData(
            new Category("Electronics", "/images/categories/electronics.jpg")
            {
                Id = 1,
            ...
            new Category("Home Appliances", "/images/categories/home_appliances.jpg")
            {
                Id = 2,
                Description = "Appliances to make your home comfortable.",
                IsActive = true,
                IsDeleted = false,
                CreateDate = DateTime.UtcNow
            },
            new Category("Fashion", "/images/categories/fashion.jpg")
            {
                Id = 3,
            ...
            new Category("Books", "/images/categories/books.jpg")
            {
                Id = 4,
            ...
            new Category("Sports & Outdoors", "/images/categories/sports_outdoors.jpg")
            {
                Id = 5,
                Description = "Gear for your sports and outdoor adventures.",
                IsActive = true,
                IsDeleted = false,
                CreateDate = DateTime.UtcNow
            },
            new Category("Toys & Games", "/images/categories/toys_games.jpg")
            {
                Id = 6,
                Description = "Toys and games for kids and adults alike.",
                IsActive = true,
                IsDeleted = false,
                CreateDate = DateTime.UtcNow
            },
            new Category("Beauty & Personal Care", "/images/categories/beauty_care.jpg")
            {
                Id = 7,
            ...
            new Category("Groceries", "/images/categories/groceries.jpg")
            {
                Id = 8,
                Description = "Everyday grocery and household needs.",
                IsActive = true,
                IsDeleted = true, // Deleted category
                CreateDate = DateTime.UtcNow
            },
            new Category("Furniture", "/images/categories/furniture.jpg")
            {
                Id = 9,
            ...
            new Category("Health & Wellness", "/images/categories/health_wellness.jpg")
            {
                Id = 10,
        ...
        {
            Id = "6ab19bfe-c96a-4a64-8c22-0b92fe96a080",
