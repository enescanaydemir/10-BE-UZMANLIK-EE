...
namespace EShop.MVC.Services
{
    public class ProductService : IProductService
    {
        ...
        {
            var response = await _httpClientService.GetAsync<ResponseModel<List<ProductModel>>>($"products/get/all/actives?isActive={isActive}");
            return response!;
        }
        ...
        {
            var response = await _httpClientService.DeleteAsync<ResponseModel<NoContent>>($"products/get/harddelete/{id}");
            return response!;
        }
