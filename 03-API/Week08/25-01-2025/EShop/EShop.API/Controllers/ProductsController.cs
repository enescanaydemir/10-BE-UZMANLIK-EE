...
namespace EShop.API.Controllers
{
    ...
    public class ProductsController : CustomControllerBase
    {
        ...
        {
            //Katergorisiz ürün kaydetme sorunumuz var, ilgileneceğiz.
        ...
        public async Task<IActionResult> GetByIdWhithCategories(int id)
        {
...
//Ne metod yazmamız gerektiğini controller  için, servislere bakaarak anlayabiliyoruz. 
