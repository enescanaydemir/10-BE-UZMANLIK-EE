...
namespace EShop.Services.Abstract
{
    public interface IOrderService
    {
        ...
        Task<ResponseDto<IEnumerable<OrderDto>>> GetAllAsync(OrderStatus orderStatus, string? applicationUserId = null); //Tüm siparişleri getirme. parametre olarak sipariş durumuna göre siparişleri getirecek
