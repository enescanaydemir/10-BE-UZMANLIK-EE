...
namespace EShop.Services.Abstract
{
    public interface IProductService
    {
        ...
        Task<ResponseDto<ProductDto>> GetWithCategoriesAsync(int categoryId); // Kategoriye göre ürünleri getirmek için!!!! 
        ...
        Task<ResponseDto<IEnumerable<ProductDto>>> GetAllWithCategoriesAsync(); // Tüm ürünleri kategorileri ile birlikte getirme
        Task<ResponseDto<IEnumerable<ProductDto>>> GetByCategoryAsync(int categoryId); // Tüm ürünleri kategorileri ile birlikte getirme
