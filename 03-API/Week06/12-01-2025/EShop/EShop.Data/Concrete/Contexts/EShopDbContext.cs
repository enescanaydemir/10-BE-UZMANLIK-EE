...
{
    public EShopDbContext(DbContextOptions options) : base(options) // base sınıfına options parametresini gönderiyoruz. dependency injection yapısı ile options parametresini alıyoruz.
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        adminUser.PasswordHash = hasher.HashPassword(adminUser, "Qwe123.,"); //yukarıdan alta taşıdık çünkü passwordhash null oluyordu
        ...
        normalUser.PasswordHash = hasher.HashPassword(normalUser, "Qwe123.,");//yukarıdan alta taşıdık çünkü passwordhash null oluyordu
